...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.PlanetCode = field.NewString(tableName, "planet_code")
...
type user struct {
	...
	UserStatus   field.Int32  // 用户状态 0-正常
	CreateTime   field.Time   // 创建时间
	UpdateTime   field.Time   // 更新时间
	IsDelete     field.Field  // 是否删除（逻辑删除）
	UserRole     field.Int32  // 用户角色 0-普通用户 1-管理员
	PlanetCode   field.String // 星球编号
...
func (u *user) updateTableName(table string) *user {
	...
	u.PlanetCode = field.NewString(table, "planet_code")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["planet_code"] = u.PlanetCode
}
